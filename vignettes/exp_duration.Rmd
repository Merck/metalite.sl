---
title: "Getting Started with Exposure Duration Table"
output:
...
vignette: >
  ...
  %\VignetteIndexEntry{Getting Started with Exposure Duration Table}
---
...
```{r}
tbl <- format_exp_duration(outdata)
head(tbl$tbl)
```
...
```{r, warning=FALSE}
outdata <- format_exp_duration(outdata) |>
  rtf_exp_duration(
