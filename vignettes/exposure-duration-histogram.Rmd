...
<<<<<<< HEAD
# library(metalite.ae)
devtools::load_all("/home/mali8/baamr_project/metalite.ae")
data("metalite_ae_adexsum", package = "metalite.ae")
=======
library(metalite.ae)
data("metalite_ae_adexsum", package = "metalite.ae") 
>>>>>>> fb80667 (Check-in 2nd time - issue 121 add subset to define parameter in interactive exposure dur histogram)
