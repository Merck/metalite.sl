...
- Fix a bug to correct the order of the first-level header of a table
  ...
  groups in `base_char_subgroup()` (#80).
...
- Update
  ...
  under which a drill-down list is available for a disposition (#74,
  \#77, \#93).
- Update
  ...
  `duration_category_list`, and `duration_category_labels` (#76).
- Update
  ...
  of SEX, and change the variable name of medication disposition (#77,
  \#78).
